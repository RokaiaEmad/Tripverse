...
<div class="trip-tabs">
    <div class="switch-bar">
        <a href="ItineraryController.php" class="<?= $activeTab == 'itinerary' ? 'active' : '' ?>">
            <i class="fa-regular fa-map"></i> <span>Itinerary</span>
        </a>
        <a href="expenses.php" class="<?= $activeTab == 'expenses' ? 'active' : '' ?>">
            <i class="fa-solid fa-wallet"></i> <span>Expenses</span>
        </a>
        <a href="documents.php" class="<?= $activeTab == 'documents' ? 'active' : '' ?>">
            <i class="fa-regular fa-file-lines"></i> <span>Documents</span>
        </a>
        <a href="voteController.php" class="<?= $activeTab == 'votes' ? 'active' : '' ?>">
            <i class="fa-solid fa-chart-simple"></i> <span>Votes</span>
        </a>
    </div>
</div>